...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../index.html"><span class="glyphicon glyphicon-home"></span> People Awards 2019</a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="emp_page.php"><span class="glyphicon glyphicon-home"></span></a></li>
                <li class="dropdown">
...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <h3 style="text-align: center;">Szavazólap Választó</h3><hr />
            <h4>Üdvözöljük <?php echo $_SESSION['NAME']; ?>!</h4>
            <ul>
                <li>Mindkét szavazólapon szavazhat.</li>
                <li>Kategóriánként egy jelöltre lehet érvényesen szavazni.</li>
                <li>A leadott szavazat nem visszavonható</li>
            </ul>
            <hr /><hr />
            <?php if($rtnReadOrg) { ?>
            <form action="voting_page.php" method="GET" role="form">
                <div class="form-group">
                    <label for="organization">Szavazólap Választó </label>
                ...
                <div class="form-group">
                    <input type="submit" name="submit" value="Elküld" class="btn btn-info">
                </div>
            </form>
                <?php $rtnReadOrg->free(); ?>
            <?php } //End if ?>
