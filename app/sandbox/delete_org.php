        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="add_org.php"><span class="glyphicon glyphicon-plus-sign"></span>Új Szervezet</a></li>
                    ...
                    <li><a href="add_voters.php"><span class="glyphicon glyphicon-plus-sign"></span>Új Szavazók</a></li>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                if(isset($_GET['id'])) {
                    ...
                    echo "<div class='alert alert-danger'>Biztos hogy törölni szeretné a szervezetet? <a href='http://localhost/peopleawards_voting2019/app/sandbox/delete_org.php?del_id=$org_id'>Igen</a> | <a href='http://localhost/peopleawards_voting2019/app/sandbox/add_org.php'>Nem</a></div>";
                }
