        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                if(isset($_GET['id'])) {
                    ...
                    echo "<div class='alert alert-danger'>Biztos benne, hogy törölni szeretné a kiválasztott kategóriát? <a href='http://localhost/peopleawards_voting2019/app/sandbox/delete_pos.php?del_id=$pos_id'>Igen</a> | <a href='http://localhost/peopleawards_voting2019/app/sandbox/add_pos.php'>Nem</a></div>";
                }
