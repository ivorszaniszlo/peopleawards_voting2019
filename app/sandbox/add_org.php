            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="http://localhost/peopleawards_voting2019/app/sandbox/edit_org.php?id=<?php echo $rowOrg['id']; ?>"><span class="glyphicon glyphicon-edit"></span></a></td>
                        <td><a href="http://localhost/peopleawards_voting2019/app/sandbox/delete_org.php?id=<?php echo $rowOrg['id']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                    </tr>
                    <?php } //End while ?>
                </table>
                <?php $rtnReadOrg->free(); ?>
