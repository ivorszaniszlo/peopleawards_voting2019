    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            if(isset($_GET['id'])) {
                ...
                echo "<div class='alert alert-danger'>Biztosan törölni szeretné a kiválasztott szavazót? <a href='http://localhost/peopleawards_voting2019/app/sandbox/delete_voter.php?del_id=$voter_id'>Igen</a> | <a href='http://localhost/peopleawards_voting2019/app/sandbox/add_voters.php'>Nem</a></div>";
            }
