...
<div class="container">
    <div class="row">
        <?php if($rtnReadOrg) { ?>
        <div class="col-md-3">
            <h3>Szervezet Kiválasztása</h3><hr>
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="GET" role="form">
                ...
                <button type="submit" name="submit" class="btn btn-info">Elküldés</button>
            </form>
        </div>
            <?php $rtnReadOrg->free(); ?>
        <?php } //End if ?>
        ...
        <div class="col-md-9">
            ...
            if(!isset($_GET['organization'])) {
                echo "<div class='alert alert-warning'>Kérjük, válassza ki a szervezetet, és kattintson az elküldés gombra a szavazás eredményének megjelenítéséhez.</div>";
            } else {
