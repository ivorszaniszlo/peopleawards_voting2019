    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            if(isset($_GET['id'])) {
                ...
                echo "<div class='alert alert-danger'>Biztos benne, hogy szeretné törölni a jelöltet? <a href='http://localhost/peopleawards_voting2019/app/sandbox/delete_nominee.php?del_id=$nom_id'>Igen</a> | <a href='http://localhost/peopleawards_voting2019/app/sandbox/add_nominees.php'>Nem</a></div>";
            }
